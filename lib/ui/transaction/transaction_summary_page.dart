...
class TransactionSummaryPage extends StatelessWidget {
  ...
  const TransactionSummaryPage({Key? key, required this.transaction})
      : super(key: key);
            ...
            child: SingleChildScrollView(
                child: Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          Text("Veuillez confirmer votre virement",
                          ...
                          const Divider(height: 30, thickness: 0),
                          ElevatedButton(
                              ...
                              onPressed: () async {
                                FundTransaction fundTransaction =
                                  ...
                                  accountFrom:
                                      transaction.accountFrom.documentId,
                                  accountTo: transaction.accountTo.documentId,
                                  amount: transaction.amount,
                                  title: transaction.title,
                                  description: transaction.description,
                                  type: transaction.transactionType,
                                  approvalStatus: transaction.transactionType ==
                                          ETransactionType.Creance
                                ...
                                try {
                                  firebaseAdapter
                                      .processTransaction(fundTransaction)
                                      .then((value) {
                                    ScaffoldMessenger.of(context)
                                        ...
                                        .closed
                                        .then((reason) => Navigator.pushNamed(
                                            context, '/account',
